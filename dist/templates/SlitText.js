...
const SlitText = ({ text, className = '', speed = 0.7 }) => {
    ...
    return (react_1.default.createElement("h1", { className: ` font-black text-4xl  ${className}` },
        react_1.default.createElement("span", { ref: textRefs }, text[currentIndex].split('').map((char, index) => (react_1.default.createElement("span", { key: index }, char))))));
};
exports.default = SlitText;
...
//# sourceMappingURL=SlitText.js.map