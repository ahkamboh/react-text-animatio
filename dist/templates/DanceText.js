...
const DanceText = ({ text, speed = 0.4, direction = "none", className = "" }) => {
    ...
    return (react_1.default.createElement("h1", { className: `relative font-black text-4xl ml440 ${className}` },
...
//# sourceMappingURL=DanceText.js.map